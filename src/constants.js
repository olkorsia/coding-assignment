export const API_KEY = 'bfc4efe3b7fbd8056b5993a4037f4a32'
...
export const ENDPOINT_DISCOVER = ENDPOINT + '/discover/movie?&include_adult=false&include_video=false&language=en-US&sort_by=vote_count.desc'
